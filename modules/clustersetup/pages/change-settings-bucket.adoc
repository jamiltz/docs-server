...
[#access_bucket_tab]
image::picts/accessBucketTab.png[,80,align=left]
...
image::picts/bucketsViewInitialEdit.png[,880,align=left]
...
image::picts/bucketsViewWithExpandedBucketRow.png[,820,align=left]
...
[#edit_bucket_button]
image::picts/editBucketButton.png[,260,align=left]
...
All the settings contained here are described in detail for the [.uicontrol]*Add Data Bucket* dialog, in the section xref:clustersetup:create-bucket.adoc[Create a Bucket]
...
* *Flush*: This setting enables or disables the xref:clustersetup:bucket-flush.adoc[Flush] command for the current bucket.
...
+
[#flush_bucket_button]
image::picts/flushBucketButton.png[,360,align=left]
+
{blank}
+
