...
For more information, see xref:clustersetup:manage-groups.adoc#mangage-server-groups[Managing Server Groups].
* To add a new server, click [.uicontrol]*Add Server*.
For more information, see xref:clustersetup:adding-nodes.adoc#topic_ncd_gdg_q4[Adding a Node].
