...
image::../images/admin-tasks-rebalance-node-added.png[,align=left]
...
For more information about server groups, see xref:clustersetup:manage-groups.adoc#mangage-server-groups[Managing Server Groups].
