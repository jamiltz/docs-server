...
image::picts/groupsEditGroupNameTab.png[,140,align=left]

This brings up the *Edit Group Name* dialog:

[#groups_edit_group_name_dialog]
image::picts/groupsEditGroupNameDialog.png[,260,align=left]
...
image::picts/groupsAddGroupTab.png[,120,align=left]
+
{blank}
+
...
image::picts/groupsAddGroupDialog.png[,260,align=left]
+
{blank}
+
{blank}
...
image::picts/groupsServerGroupsNewGroupAdded.png[,820,align=left]
+
{blank}
+
{blank}
...
image::picts/groupsAccessMoveServerTab.png[,740,align=left]
+
{blank}
+
...
image::picts/groupsPendingMoveNotification.png[,740,align=left]
+
{blank}
+
{blank}
...
image::picts/groupsResetAndApplyChangesButtons.png[,220,align=left]
...
image::picts/groupsRebalanceFollowingMove.png[,820,align=left]
+
{blank}
+
...
image::picts/groupsScreenWithOpenGroup.png[,820,align=left]
+
{blank}
+
{blank}
...
image::picts/groupsConfirmServerRemovalNotice.png[,340,align=left]
+
{blank}
+
...
image::picts/groupsRemovalPendingNotification.png[,740,align=left]
+
{blank}
+
{blank}
...
image::picts/groupsRebalanceButton.png[,100,align=left]
+
{blank}
+
...
image::picts/groupsFollowingServerRemoval.png[,740,align=left]
+
{blank}
+
...
+
[#groups_empty_group]
image::picts/groupsEmptyGroup.png[,740,align=left]
+
{blank}
+
{blank}
...
+
[#groups_delete_group]
image::picts/groupsDeleteGroup.png[,100,align=left]
+
{blank}
+
...
image::picts/groupsDeleteGroupConfirmation.png[,260,align=left]
+
{blank}
+
...
image::picts/groupsSelectFromAddServerDialog.png[,340,align=left]
