...
| Run Couchbase Server using the Red Hat OpenShift Container Platform.
 ...
 xref:install:getting-started-docker.adoc#topic_mln_twc_3w[Running Couchbase Server using Docker]
| 
 xref:install:couchbase-using-openshift-container.adoc#run-couchbase-openshift-container[Running Couchbase Server Using Red Hat OpenShift]
| 
|===
