...
For next steps, see xref:install:init-setup.adoc#topic12527[Initializing the Cluster], xref:install:startup-shutdown.adoc#topic_frj_trw_hw[Couchbase Server Startup and Shutdown], and xref:install:testing.adoc#topic3291[Verifying Your Couchbase Server Installation].
