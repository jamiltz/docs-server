...
You should follow the sizing guidelines detailed in xref:install:sizing-general.adoc[Sizing Guidelines] when deciding on machine specifications to run Couchbase Server.
