...
See xref:install:install-platforms.adoc#topic1634[Supported Platforms] for details.
...
xref:install:thp-disable.adoc#topic_wmm_1ps_pv[Disabling Transparent Huge Pages (THP)] prior to installing Couchbase Server is strongly encouraged.
