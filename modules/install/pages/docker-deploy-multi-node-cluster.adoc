...
For details, see xref:install:install-ports.adoc[Network Configuration].
+
...
+
For detailed information on configuring the server, see xref:install:init-setup.adoc[Initializing the Cluster]
...
image:picts/cluster-setup-add-servers.png[,570]
 .. Click [.uicontrol]*Add Server* again and specify the IP address you captured for db2
 .. Click [.uicontrol]*Rebalance*.image:picts/docker-single-node-rebalance.png[,570]
...
image:picts/docker-multi-node-rebalance.png[,570]
