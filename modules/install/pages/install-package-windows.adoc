...
See xref:install:install-platforms.adoc#topic1634[Supported platforms] for the complete list of platforms supported by Couchbase Server.
...
. After installation, follow the instructions to xref:install:init-setup.adoc[setup Couchbase Server].
