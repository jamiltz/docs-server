...
The Eventing Service depends on the xref:understanding-couchbase:data-service.adoc[Data Service], which must therefore be running on at least one cluster node.
