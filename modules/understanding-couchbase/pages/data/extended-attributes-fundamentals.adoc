...
Within Couchbase Server, the maximum size for each document is 20 megabytes (see the section xref:understanding-couchbase:data.adoc#size-limits[Size Limits], on the page xref:understanding-couchbase:data.adoc[Data]).
