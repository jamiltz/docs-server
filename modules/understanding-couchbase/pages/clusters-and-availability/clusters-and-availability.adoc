...
Additionally, xref:understanding-couchbase:groups.adoc#groups[Server Group Awareness] allows _groups_ of nodes to be defined, within the cluster, to protect the cluster against significant infrastructure-failure.
