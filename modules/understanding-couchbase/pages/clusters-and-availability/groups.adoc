...
For information on vBuckets, see xref:..:understanding-couchbase/buckets-memory-and-storage/buckets.adoc[Buckets].

For information on the standard (non-Group-based) distribution of replica vBuckets across a cluster, see xref:..:understanding-couchbase/clusters-and-availability/replication-architecture.adoc[Availability].
...
[#groups_two_equal]
image::groups-two-equal.png[,720,align=left]
...
[#groups_two_unequal]
image::groups-two-unequal.png[,720,align=left]
...
image::groups-two-failover-one-node.png[,720,align=left]
