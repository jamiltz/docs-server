...
Note that if the xref:security:security-auditing.adoc#topic_a5p_npm_lq[auditing] option is enabled, all rotation-requests are audited by Couchbase Server.
