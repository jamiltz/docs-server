...
See xref:security:secret-mgmt.adoc#topic_s2r_2yt_gy[Secret-Management] for details on how to define and use the master password.
...
For details, see xref:security:security-data-encryption.adoc[Encryption at Rest].
