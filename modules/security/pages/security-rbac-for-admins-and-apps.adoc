...
For more information on defining users locally and externally, see xref:security:security-authentication.adoc[Authentication].
...
For a complete account of the roles you can allocate and their significance, see xref:security:security-roles.adoc[Roles].
