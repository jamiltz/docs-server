...
(See xref:security:security-authentication.adoc[Authentication], for information on authentication domains.) Left-click on the *Save* button, to save the list of users.
...
For a complete list of events, see the section xref:security:security-audit-events.adoc[Audit Events].
