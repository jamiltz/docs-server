...
See xref:security:security-x509certsintro.adoc#configuring-x.509[Configuring X.509].
...
Appropriate _paths_, _prefixes_, and _delimiters_ can be specified: for detailed information on certificate-identity extraction, see xref:security:security-certs-auth.adoc[Certificate-Based Authentication].
