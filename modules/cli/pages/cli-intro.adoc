...
You can collect diagnostics through the command-line interface by using either the xref:cli:cbcli-intro.adoc#cbcli-intro[couchbase-cli] couchbase-cli tool or the xref:cli:cbcollect-info-tool.adoc#cbcollect-info-tool[cbcollect_info] cbcollect_info tool.
