...
For more information, see xref:cloud:couchbase-azure-marketplace.adoc#topic_rfg_qjt_xs[Deploying Couchbase from Azure Marketplace].
// You can also deploy Couchbase
//       using the ARM templates we host on GitHub.
// For more information, see <xref
//         href="#topic_ghd_55f_nbb/azure-cli" format="dita"/>.

Best practices when deploying on Azure are available xref:cloud:couchbase-azure-best-practices.adoc#topic_ghd_55f_nbb[here].
