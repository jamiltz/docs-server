...
For more information, see xref:cloud:couchbase-aws-marketplace.adoc#topic_rfg_qjt_xs[Deploying Couchbase from AWS Marketplace].
...
Best practices when deploying on AWS are available xref:cloud:couchbase-aws-best-practices.adoc#topic_ghd_55f_nbb[here].
