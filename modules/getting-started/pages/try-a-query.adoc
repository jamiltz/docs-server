...
The final step in the _Getting Started_ sequence, xref:getting-started:choose-your-next-steps.adoc[Choose Your Next Steps], offers suggestions for learning more about Couchbase and using it for production use-cases.
