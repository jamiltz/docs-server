...
You can now proceed directly to the next stage of the _Getting Started_ sequence, and xref:getting-started:look-at-the-results.adoc[Look at the Results] of your installation and configuration, using the _Couchbase Web Console_.
