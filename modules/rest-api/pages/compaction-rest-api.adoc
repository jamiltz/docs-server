...
* To update the bucket compaction settings using the CLI, see xref:cli:cbcli/couchbase-cli-bucket-compact.adoc[cli:cbcli/couchbase-cli-bucket-compact.adoc].
