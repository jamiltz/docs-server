...
For examples of both selecting and custom-creating analyzers by means of the Couchbase Web Console, see xref:fts:fts-creating-indexes.adoc[Creating Indexes].
...
This is explained and exemplified in xref:fts:fts-creating-indexes.adoc[Creating Indexes].
...
For examples, see xref:fts:http:http:/www.unicode.org/reports/tr29.adoc#Word_Boundaries[Unicode Word Boundaries].
+
{blank}
...
For examples of selection, see xref:fts:fts-creating-indexes.adoc[Creating Indexes].
