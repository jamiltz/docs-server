...
For more information on cbbackupmgr, see xref:backup-restore:enterprise-backup-restore.adoc[cbbackupmgr Tool].
...
{blank}
+
For more information on these tools, see xref:cli:cbbackup-tool.adoc#cbbackup-tool[cbbackup] and xref:cli:cbrestore-tool.adoc#cdbrestore-tool[cbrestore].
