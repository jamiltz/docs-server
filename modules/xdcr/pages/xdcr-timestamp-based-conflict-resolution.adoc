...
See xref:xdcr:xdcr-monitor-timestamp-conflict-resolution.adoc[Monitoring XDCR Timestamp-based Conflict Resolution] for more details.
...
Other configurations must use xref:xdcr:xdcr-conflict-resolution.adoc#revision-id-based-conflict-resolution[Revision ID based conflict resolution].
...
[#image_zfm_45b_yy]
image::picts/timestamp_datacenter_locality.png[,570]
