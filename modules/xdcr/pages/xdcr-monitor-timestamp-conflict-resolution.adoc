...
Please ensure that NTP is set up correctly on all nodes across the replication topology and clocks are synchronized.`" image:picts/xdcr-timestamp-conflict-resolution-alert.png[,450]
