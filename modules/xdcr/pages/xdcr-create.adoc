...
[#image_vwk_d2t_zs]
image::picts/xccr-create.png[,920,align=left]
...
+
[#image_zds_pjt_zs]
image::picts/xdcr-create-replication.png[,380,align=left]
...
[#image_i12_h15_zs]
image::picts/xdcr-adv-filtering.png[,380,align=left]
...
+
[#image_ltl_q25_zs]
image::picts/xdcr-pause-resume.png[,720,align=left]
...
[#image_tfl_mg5_zs]
image::picts/xdcr-replication-statuis.png[,450,align=left]
