...
+
[#image_rzb_vk5_zs]
image::picts/xdcr-recover-partition-1.png[,720,align=left]
...
+
[#image_ngh_bl5_zs]
image::picts/xdcr-recover-partition-2.png[,720,align=left]
+
...
+
[#image_wwv_nl5_zs]
image::picts/xdcr-recover-partition-4.png[,720,align=left]
...
+
[#image_x1h_cq5_zs]
image::picts/xdcr-recovery-process-1.png[,450,align=left]
...
+
[#image_hxy_hq5_zs]
image::picts/xdcr-recovery-process-2.png[,500,align=left]
+
...
+
[#image_z2p_pq5_zs]
image::picts/xdcr-recovery-process-3.png[,600,align=left]
