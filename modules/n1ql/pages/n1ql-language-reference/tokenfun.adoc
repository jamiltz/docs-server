...
*Arguments*::
*input_obj*;; Any JSON object, or any valid xref:n1ql:index.adoc[expression] which evaluates to a string, to search within.

*token_expr*;; A token string, or any valid xref:n1ql:index.adoc[expression] which evaluates to a string, that is being searched for.
