...
[#ol_y3h_jzm_5z]
. *Adaptive Indexes are bound to the limitations of Array Indexes* because they are built over xref:n1ql:indexing-arrays.adoc#topic_hv4_sbr_w5[Array Indexing] technology.
...
+
[#image_bkl_dr2_dbb]
image::adaptive-indexing_Q7-Q8_Results.png[]
