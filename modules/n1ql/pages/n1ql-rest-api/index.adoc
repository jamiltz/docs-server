...
See  xref:n1ql:examplesrest.adoc[Examples] for REST API samples.
...
*scan_vector*
+
See `at_plus` parameter in the previous table xref:n1ql:executen1ql.adoc#table_xmr_grl_lt[scan_consistency parameters].
+
*scan_wait*
+
